...
from ..agents.async_market_data_agent import AsyncMarketDataAgent
from ..clients.async_binance_client import AsyncBinanceClient
from ..agents.async_signal_agent import AsyncSignalAgent
from ..agents.async_risk_management_agent import AsyncRiskManagementAgent
...
class AsyncTradingOrchestrator:
    ...
    def __init__(
        ...
        # Use fully async agents
        self.signal_agent = AsyncSignalAgent(
            market_data_agent=self.async_market_agent,
            strategy_name=strategy_name,
            strategy_parameters=strategy_parameters
        )
        self.risk_agent = AsyncRiskManagementAgent()
        
        # Execution agent remains synchronous for now, but is called via async client
    ...
    async def execute_trading_workflow(
        ...
        try:
            ...
            signal_result = await self.signal_agent.generate_signal(
            ...
            risk_result = await self.risk_agent.validate_trade(
                symbol=symbol,
