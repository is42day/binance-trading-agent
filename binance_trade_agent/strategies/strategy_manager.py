...
class StrategyManager:
    ...
    def _initialize_default_strategies(self):
        ...
        try:
            ...
            self.register_strategy("edge", edge_strategy)
        ...
        try:
            ...
            self.register_strategy("combined_edge", combined_edge_balanced)
    ...
    def create_strategy(
        self, strategy_type: str, name: str, parameters: Dict[str, Any] = None
    ) -> bool:
        """
    ...
    def analyze_with_strategy(
        self, strategy_name: str, market_data: List[Dict[str, Any]], symbol: str = None
    ...
    def _calculate_strategy_performance(
        self, name: str, history: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
