...
class TestAgentStateManagement:
    ...
    def test_start_agent_creates_trading_loop(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_start_agent_when_already_running(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_stop_agent_sets_stop_flag_and_cancels_task(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_restart_agent_stops_and_starts(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_restart_agent_when_not_running(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
...
class TestAgentControlWithDefaultParameters:
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_start_agent_default_parameters(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
...
class TestAgentControlErrorHandling:
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_start_agent_handles_exceptions(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
    ...
    @patch("binance_trade_agent.dashboard.utils.data_fetch.AutonomousTradingLoop")
    @patch("binance_trade_agent.dashboard.utils.data_fetch.asyncio.get_event_loop")
    def test_stop_agent_handles_exceptions(
        self, mock_get_loop, mock_trading_loop_class, reset_agent_state
    ):
